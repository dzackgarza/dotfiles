...
class StartupSequenceManager:
    ...
    async def create_startup_proof(self, plugins_displayed: int) -> StartupComplete:
        """
        Create startup completion proof without display.
        
        Used when plugins were already displayed through timeline system.
        """
        import time
        ...
        startup_duration = time.time() - self.startup_start_time
        self.displayed_plugins = plugins_displayed
