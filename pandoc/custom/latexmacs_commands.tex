...
\newcommand{\bbcpt}[1]{\overline{ #1 }^{\bb}}
\newcommand{\ksbacpt}[1]{\overline{ #1 }^{\scriptsize \KSBA}}
\newcommand{\torcpt}[1]{\overline{ #1 }^{\scriptsize \mathrm{tor} }}
\newcommand{\torcptf}[1]{\overline{ #1 }^{\scriptsize \mathrm{tor}(F) }}
\newcommand{\rc}[1]{\overline{ #1 }^{\scriptsize \mathrm{rc}}}
