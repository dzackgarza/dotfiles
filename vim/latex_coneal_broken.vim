...
if has("conceal") && &enc == 'utf-8'
 ...
 if s:tex_conceal =~# 'm'
  ...
  syn match texMathSymbol '\\cline' contained conceal cchar=-
  ...
  " Hidden
  syn match texMathSymbol '\\centering' contained conceal cchar=  
  syn match texMathSymbol '\\correspond' contained conceal cchar=  
  syn match texMathSymbol '\\substack' contained conceal cchar=  
  syn match texMathSymbol '\\qty' contained conceal cchar=  
  syn match texMathSymbol '\\small' contained conceal cchar=  
  ...
  " Turn of spelling within a command
  "
  ...
  syn match texMathSymbol '\\Aut' contained conceal cchar=𝓐
  syn match texMathSymbol '\\mathcal{B}' contained conceal cchar=𝓑
  syn match texMathSymbol '\\mcb' contained conceal cchar=𝓑
  syn match texMathSymbol '\\mathcal B' contained conceal cchar=𝓑
  ...
  syn match texMathSymbol '\\Gal' contained conceal cchar=𝓖
  ...
  syn match texMathSymbol '\\im\>' contained conceal cchar=𝓘
  ...
  syn match texMathSymbol '\\jacobsonrad' contained conceal cchar=𝓡
  syn match texMathSymbol '\\mathcal{R}' contained conceal cchar=𝓡
  syn match texMathSymbol '\\spec' contained conceal cchar=𝓢
  ...
  syn match texMathSymbol '\\kk' contained conceal cchar=𝕜
  syn match texMathSymbol '\\bbm' contained conceal cchar=𝕄
  ...
  syn match texMathSymbol '\\notdone' contained conceal cchar=🚩

  " Fraktur
  syn match texMathSymbol '\\lieg' contained conceal cchar=𝖌
  syn match texMathSymbol '\\lieh' contained conceal cchar=𝖍
  syn match texMathSymbol '\\lies' contained conceal cchar=𝖘
  syn match texMathSymbol '\\lieb' contained conceal cchar=𝖇
  syn match texMathSymbol '\\lien' contained conceal cchar=𝖓
  syn match texMathSymbol '\\mfn' contained conceal cchar=𝖓
  syn match texMathSymbol '\\mfp' contained conceal cchar=𝖕
  syn match texMathSymbol '\\mfq' contained conceal cchar=𝖖
  syn match texMathSymbol '\\mfm' contained conceal cchar=𝖒
...
"     call Decho("SuperSub: group<".a:group."> leader<".a:leader."> pat<".a:pat."> cchar<".a:cchar.">")
  ...
  endfun
  call s:SuperSub('texSuperscript','\^','\\infty','᪲')
  call s:SuperSub('texSuperscript','\^','\circ','∘')
