...
# Main window geometry
main_window_geometry = cPickle.loads('\x80\x02csip\n_unpickle_type\nq\x01U\x0cPyQt5.QtCoreq\x02U\nQByteArrayU2\x01\xd9\xd0\xcb\x00\x02\x00\x00\x00\x00\x03\x10\x00\x00\x00\x1a\x00\x00\x07z\x00\x00\x04(\x00\x00\x03\x10\x00\x00\x006\x00\x00\x07z\x00\x00\x04(\x00\x00\x00\x00\x00\x00\x00\x00\x07\x80\x85\x87Rq\x03.')
...
save_to_disk_template_history = cPickle.loads('\x80\x02]q\x01(Xg\x00\x00\x00{author_sort:re("[^A-Za-z0-9]", "_")}/{title:re("[^A-Za-z0-9]", "_")}_{authors:re("[^A-Za-z0-9]", "_")}q\x02XT\x00\x00\x00{author_sort:re([^A-Za-z0-9], \'\')}/{title:transliterate()}_{authors:transliterate()}q\x03X\x15\x00\x00\x00{author_sort}/{title}q\x04X)\x00\x00\x00{author_sort}/{title}/{title} - {authors}q\x05X*\x00\x00\x00{author_sort:re([^A-Za-z0-9], \'\')}/{title}q\x06XW\x00\x00\x00{author_sort:re("[^A-Za-z0-9]", "_")}/{title:transliterate()}_{authors:transliterate()}q\x07XF\x00\x00\x00{author_sort:file_clean()}/{title:file_clean()}_{authors:file_clean()}q\x08X"\x00\x00\x00{author_sort:file_clean()}/{title}q\tX/\x00\x00\x00{author_sort:file_clean()}/{title:file_clean()}q\ne.')
...
main_search_history = cPickle.loads('\x80\x02]q\x01(X\x07\x00\x00\x00munkresq\x02X\x07\x00\x00\x00fomenkoq\x03X\x0c\x00\x00\x00combinatoricq\x04X\x06\x00\x00\x00combinq\x05X\x05\x00\x00\x00kirbyq\x06X\x04\x00\x00\x00bonaq\x07X\r\x00\x00\x00combinatoricsq\x08X\x0b\x00\x00\x00homotopicalq\tX\x06\x00\x00\x00stableq\nX\x0c\x00\x00\x00more conciseq\x0bX\r\x00\x00\x00formats:falseq\x0cX\x05\x00\x00\x00ilnorq\rX\x06\x00\x00\x00milnorq\x0eX\n\x00\x00\x00combinatorq\x0fX\n\x00\x00\x00symplecticq\x10X\t\x00\x00\x00geometricq\x11X\x07\x00\x00\x00hatcherq\x12X\x06\x00\x00\x00Schillq\x13X\x07\x00\x00\x00stanleyq\x14X\x03\x00\x00\x00dugq\x15X\x04\x00\x00\x00fitzq\x16X\x04\x00\x00\x00Thomq\x17X\x07\x00\x00\x00salamonq\x18X\x06\x00\x00\x00Roydenq\x19X\x07\x00\x00\x00Follandq\x1ae.')
