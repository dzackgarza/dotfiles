...
;(function() {
    ...
    var emoji = function(){
         ...
         */
        self.img_sets = {
            'apple' : {'path' : '/emoji-data/img-apple-64/', 'sheet' : '/emoji-data/sheet_apple_32.png', 'sheet_size' : 32, 'mask' : 1},
            'google' : {'path' : '/emoji-data/img-google-64/', 'sheet' : '/emoji-data/sheet_google_32.png', 'sheet_size' : 32, 'mask' : 2},
            'twitter' : {'path' : '/emoji-data/img-twitter-64/', 'sheet' : '/emoji-data/sheet_twitter_32.png', 'sheet_size' : 32, 'mask' : 4},
            'emojione' : {'path' : '/emoji-data/img-emojione-64/', 'sheet' : '/emoji-data/sheet_emojione_32.png', 'sheet_size' : 32, 'mask' : 8},
            'facebook' : {'path' : '/emoji-data/img-facebook-64/', 'sheet' : '/emoji-data/sheet_facebook_32.png', 'sheet_size' : 32, 'mask' : 16},
            'messenger' : {'path' : '/emoji-data/img-messenger-64/', 'sheet' : '/emoji-data/sheet_messenger_32.png', 'sheet_size' : 32, 'mask' : 32},
        };
